...
/*
void Camera::rotate(const float roll_degrees, const float pitch_degrees, const float yaw_degrees) {
...
const Vector3D Camera::rotation_roll(const Vector3D& point, const float amount_r) const {
  const Vector3D rotated_point(
    point.x,
...
const Vector3D Camera::rotation_pitch(const Vector3D& point, const float amount_p) const {
...
const Vector3D Camera::rotation_yaw(const Vector3D& point, const float amount_y) const {
  const Point3D rotated_point(
